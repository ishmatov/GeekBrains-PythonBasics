...
вернет строку: *****\n*****\n*****.
Подсказка: подробный список операторов для перегрузки доступен https://pythonworld.ru/osnovy/peregruzka-operatorov.html.
"""
...
class Cell:
    ...
    def __sub__(self, other):
        if self.count < other.count:
            print(f"Нельзя из меньшего {self.count} вычитать большее {other.count}")
            return 0
        return Cell(self.count - other.count)
    ...
    def __str__(self):
        return str(self.count) + " (" + ("*" * self.count) + ")"
...
print(c1)
print(c2)
print(f"Сложение клеток {c1 + c2}")
print(f"Разница клеток {c1 - c2}")
print(f"Произведение клеток {c1 * c2}")
print(f"Деление клеток {c1 / c2}")
print()
c1.make_order(5)
